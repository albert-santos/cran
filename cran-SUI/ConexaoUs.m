function [Us, Small] = ConexaoUs(Us, Small)
    ...
    end   % Calcula o SINR, CQI e DR (1 PRB) de cada usu�rio para cada Small

    
    % Identificando a quantidade PRB requisitadas por cadas usu�rio
    % A prioridade de conex�o ser� primeiro para os usu�rios que demandam
...
%     % Organizando em ordem crescente pela quantidade de PRB requisitados de cada usu�rio
